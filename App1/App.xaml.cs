...
using ObfuscateCORE.Core.Contracts.Services;
using ObfuscateCORE.Core.Services;
using ObfuscateCORE.Models;
using ObfuscateCORE.Services;
using ObfuscateCORE.ViewModels;
using ObfuscateCORE.Views;
...
namespace ObfuscateCORE
{
    ...
    public partial class App : Application
    {
        ...
        private void ConfigureServices(HostBuilderContext context, IServiceCollection services)
        {
            ...
            services.AddTransient<CsharpViewModel>();
            services.AddTransient<CsharpPage>();

            services.AddTransient<PHPViewModel>();
            services.AddTransient<PHPPage>();

            services.AddTransient<URLViewModel>();
            services.AddTransient<URLPage>();
